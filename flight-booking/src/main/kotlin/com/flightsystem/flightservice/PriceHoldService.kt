...
import com.flightsystem.model.PriceHoldDetails
    ...
    fun createHold(
        ...
        transaction {
            ...
            if (seatsFromDb.size != seatNumbers.size) {
                ...
                // if DB returns fewer seats than requested, some seat nums are invalid
            }
